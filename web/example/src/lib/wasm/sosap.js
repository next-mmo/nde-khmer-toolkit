export class Model {
     ...
     * @param {string} delim
     */
    constructor(bytes, delim) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(delim, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    ...
    phoneticize(word) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.model_phoneticize(this.__wbg_ptr, ptr0, len0);
     ...
     * @returns {string[]}
     */
    phoneticize_nbest(word, nbest) {
        const ptr0 = passStringToWasm0(word, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.model_phoneticize_nbest(this.__wbg_ptr, ptr0, len0, nbest);
        var v2 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v2;
    }
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('sosap_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
